              ...
              ...List.generate(bubbleItems.length, (index) {
                return AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    final angle = (index / bubbleItems.length) * 2 * math.pi + (_bubblesController.value * 2 * math.pi);
                    ...
                    return Positioned(
                      ...
                      top: constraints.maxHeight / 2 + dy - bubbleSize / 2 + (math.sin(bubbleAnimation * math.pi) * 20),
                      width: bubbleSize,
                      height: bubbleSize,
